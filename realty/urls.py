...
from realty.edit import Realty_PageCreate, Realty_PageUpdate, Realty_PageDelete
...
#-----------------------------------------------------------------------------------------------------------------------------------------
    url(r'^(?P<cat_id>\d+)/add/$', Realty_PageCreate.as_view(), name="new_page"),# Добавить товар
